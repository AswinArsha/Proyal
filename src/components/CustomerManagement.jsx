...
const CustomerManagement = () => {
  ...
  const fetchOrderHistory = async (customerId) => {
    ...
    if (error) console.log("Error fetching order history:", error);
      ...
      <CardContent>
                  ...
                  >
                    ...
                    <TableCell className="p-4 flex space-x-2">
                      <Button
                        ...
                        className="rounded-md px-4 py-2 bg-blue-500 hover:bg-blue-400 text-white"
                      >
                        View
                      </Button>
                      <Button
                        ...
                        className="rounded-md px-4 py-2 bg-yellow-500 hover:bg-yellow-400 text-white"
                      >
                        Edit
                      </Button>
                      <Button
                        ...
                        className="rounded-md px-4 py-2 bg-red-500 hover:bg-red-400 text-white"
                      >
                        Delete
                      </Button>
                    </TableCell>
        ...
        {selectedCustomer && (
          <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
            <DialogContent className="p-6 rounded-lg shadow-lg max-w-5xl">
              <DialogHeader>
                <DialogTitle className="text-xl font-semibold">
                  Customer Details
                </DialogTitle>
